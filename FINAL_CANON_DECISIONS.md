...
| 4b | D-04b | ✅ CANONICAL | **Goblin Cultural Canon Expansion — APPROVED.** Adds Religion & Spirituality (world-teaches wisdom; First Hearth / Ancestors / Living World; shamans as recognized role, never political — varies by tribe), Death & Funerals (Stonefang memorial stone / Mossroot planted tree / Ashfire ashes-to-First-Hearth; universal *"no contribution is ever truly lost"*), Marriage as partnership of service, expanded Childhood (whole tribe teaches), Coming of Age reframed around universal **First Contribution** with each tribe's existing rite as its form (Ashfire Naming Night now gated on a completed First Contribution), Food per tribe (guest always first-served, enemies-under-truce fed), Art (beauty serves purpose), Music per tribe, Humor (self-deprecation valued), Clothing per tribe, Justice (restorative, no revenge) with a **canonical Corruption-Crime protocol** (isolate → assess → treat → last-resort mercy/containment; *"we do not give up on our own, but neither do we sacrifice the many for the one"*; goblins who die resisting Corruption honored as final contribution), Economy (barter-primary, poor work reflects on maker), Education as lifelong, Relationships with other peoples (Humans, Dwarves, Elves, Beastfolk, Gnomes, Halflings, Orcs, Vampires — with vampire nuance hook preserved: rare exceptions possible, houses remain antagonistic), three new universal holidays (First Hearth Day, Ancestors' Night, Renewal Day), Symbols (Hearth/Ember/Hand/Tree = Home/Hope/Contribution/Growth), and the closing **Final Cultural Principle** paragraph. All 8 integration assumptions flagged in `GOBLIN_CULTURE.md` §33 for review during Canon Lock. | Feb 2026 |
| 5 | V-1 | ✅ CANONICAL | **Vampires are a civilization that chose preservation over renewal.** Vampire civilization once existed as something larger than the Three Houses. It collapsed before the modern era. The Three Houses emerged as **competing philosophical responses** to that collapse — not merely political factions, but *three different sincere answers* to the question: "How should vampire civilization endure?" Each House preserves a different aspect of what was lost. **Vetharis** preserves diplomacy, hierarchy, refinement, influence, and political order — civilization survives through structure and control. **Drakmor** preserves strength, discipline, martial excellence, conquest, and endurance — civilization survives only when strong enough to defend itself. **Soleth** preserves memory, knowledge, history, scholarship, and preservation itself — civilization survives only if it remembers who it once was. **Guiding philosophical statement:** *"The Three Houses are not the remnants of vampire civilization — they are its surviving arguments. Each preserves a different answer to the question of how their people should endure, and none can prove they are right because the civilization they all claim to defend no longer exists."* **Lost civilization stays mysterious** — never fully authored; discovered gradually through ruins, forgotten laws, inscriptions, journals, abandoned gathering places, archaeological finds, oral traditions, and hidden archives. **Design tone:** vampires are ancient, static, and burdened by centuries of accumulated choices — deliberately opposite to goblins, who continually build toward the future. Goblins strive to build unity; vampires struggle with the weight of the past. **Legacy Questline seed (do not author yet):** the central question is not restoring the old civilization but *"can vampires create something new without repeating the mistakes that destroyed what came before?"* — the distinguishing philosophical spine from the goblin Legacy Questline. **Foundation for all downstream V-decisions** (V-2 Corruption vulnerability, V-3 feeding doctrine, V-4 sire/progeny, and the eventual vampire culture expansion). | Feb 2026 |
| 6 | V-2 | ✅ CANONICAL | **Vampires are not immune to the Corruption** — preserving the world's core pillar that no intelligent people are immune. However, vampires experience Corruption differently than mortal races, through a two-stage progression. **Stage 1 — The Withering (new canonical condition):** the earliest observable stage of vampire Corruption. Personality narrows; empathy erodes; flexibility of thought decreases; long-held beliefs become obsessions; the vampire increasingly defines themselves *solely* through their House's philosophy. Crucially, the vampire retains **agency**; recovery is rare but possible. This makes the Withering **tragic rather than monstrous**. **Stage 2 — Full Corruption:** if the Withering progresses unchecked, it eventually becomes full Corruption. The Corruption does not invent new beliefs — it **strips away every belief except the one the vampire refuses to surrender**. The vampire's defining philosophy becomes not stronger but **absolute**. **Per-House manifestations:** *Vetharis* — control becomes domination; diplomacy becomes manipulation; trust becomes impossible; every relationship becomes a calculated operation. *Drakmor* — discipline becomes tyranny; strength becomes brutality; duty becomes obsession; mercy disappears. *Soleth* — preservation becomes hoarding; knowledge becomes possession; memory becomes imprisonment; truth is hidden rather than protected. Corruption twists what already existed until balance is lost — fully consistent with how Corruption affects every other civilization. **Treatment:** the Withering is considered treatable, recovery rare but possible; each House approaches treatment differently. Full Corruption has **never been conclusively reversed** — some vampires believe recovery is impossible; others continue searching for a cure. This remains **deliberately unresolved** and mysterious. **House Responses:** *Vetharis* contains the situation quietly to protect stability and reputation. *Drakmor* confronts it openly and, if recovery becomes impossible, grants an honorable death. *Soleth* studies every case, preserves records, delays irreversible judgment, continues searching for understanding. **Central existential question (deliberately unanswered):** *"Was this truly the Corruption… or were we always capable of becoming this?"* Every House believes its philosophy preserves what remains of vampire civilization; watching a member become consumed by that philosophy forces this ongoing philosophical debate. **Canonical principle:** *"The Corruption does not teach vampires new beliefs. It strips away every belief except the one they refuse to surrender."* **Do not yet author mechanics, quests, or named NPC cases.** Treat as foundational canon guiding V-3, V-4, future vampire questlines, and the eventual vampire culture expansion. | Feb 2026 |
| 7 | V-3 | ✅ CANONICAL | **Vampires require blood to survive.** Blood is intentionally retained (not replaced with essence or metaphysical substitute) because it keeps vampires grounded as predators while allowing philosophical depth through their choices. **The horror is not that vampires must feed — the horror is how they choose to feed.** **Every House teaches a formal Feeding Doctrine.** Feeding is one of the primary ways each House expresses its philosophy; every newly-turned vampire is taught their House's Doctrine. **House Vetharis — The Doctrine of the Managed Draw:** feeding is an exercise in responsibility, influence, and control; a feeding that creates unnecessary instability is failure; preferred targets are carefully selected individuals whose loss or survival can be responsibly managed; wasteful killing is incompetence, not strength. **House Drakmor — The Doctrine of the Honest Hunt:** feeding acknowledges what vampires truly are; strength should never hide from truth; predation without courage is dishonorable; feeding should never be disguised as kindness. **House Soleth — The Doctrine of the Recorded Cost:** every feeding creates a debt; nothing taken should ever be forgotten; knowledge includes remembering the cost paid by others; every act of feeding should leave behind an obligation to preserve something of equal value. **The Measure (personal moral boundary — canonical concept):** in addition to House Doctrine, every vampire eventually establishes a personal **Measure** — the line they refuse to cross to satisfy their hunger. A Measure is not an oath, not a religious ritual, not enforced by House law, not tracked mechanically. It is a *narrative expression of character*, unique to each vampire, established after coming to terms with their immortality. Examples: never feed from children; never kill while feeding; only from willing donors; always learn the person's name first; never twice from the same individual; only from those who have knowingly chosen violence. Some vampires openly discuss their Measure; others never reveal it; some refine it over centuries; some slowly abandon it. **Relationship to the Withering (V-2):** breaking one's Measure *once* does not automatically indicate the Withering; but *repeatedly abandoning* one's own Measure is one of the earliest observable warning signs. Vampire society teaches: *"The first thing the Corruption takes is not your strength. It is the line you once refused to cross."* **Canonical principles (preserve in future lore):** (1) *"Every vampire has a hunger. What defines us is the line we refuse to cross to satisfy it."* (2) *"The first thing the Corruption takes is not your strength. It is the line you once refused to cross."* **Design philosophy:** the purpose of Doctrines and Measures is not to make vampires less dangerous — it is to make their choices *more meaningful*. The player judges a vampire not by whether they feed, but by *how* they choose to live with an unavoidable hunger. Reinforces the pillar: individuals are judged by their choices, not by what they are. **Do not create gameplay mechanics or UI around Measures — narrative only.** | Feb 2026 |
| 8 | V-4 | ✅ CANONICAL | **Turning another person into a vampire is one of the most serious acts a vampire can perform** — never casual, never routine, one of the greatest responsibilities within vampire civilization. **Universal principle:** *"To create another immortal is the greatest responsibility a vampire can accept."* **Consent is universal, not House-dependent.** Modern vampire civilization recognizes **informed consent** as the moral standard for turning. All three Houses agree that creating an unwilling vampire ultimately leads to suffering, instability, and repeats mistakes from their forgotten past. This is one of the few principles shared across all three Houses. **However, the Houses disagree on how meaningful consent should be obtained.** **House Vetharis — The Doctrine of the Considered Offer:** candidates are quietly observed, evaluated, and understood over many years; only after careful consideration is the offer made; the offer must always be genuine; the candidate may freely refuse; Vetharis believes poor judgment when choosing immortals threatens civilization itself. **House Drakmor — The Doctrine of the Earned Turning:** turning is offered only after someone has demonstrated courage, discipline, sacrifice, and character; consent is still required; if the candidate refuses, the House respects that decision; Drakmor believes an unwilling immortal can never become truly strong. **House Soleth — The Doctrine of the Recorded Choice:** consent must be explicit, documented, witnessed, and recorded permanently within the archives; Soleth believes memory protects both the sire and the progeny. **The Schism (canonical historical event, deliberately unresolved):** the Schism represents the historical event that convinced *all three Houses* that non-consensual turning ultimately destroys civilizations. It is NOT a moral hierarchy; each House learned a different lesson and reformed in its own philosophical way. Do not fully explain the Schism yet — it remains one of the great unresolved historical events connected to the lost vampire civilization, to be gradually revealed through archaeological discoveries, journals, ruins, and historical records. **Sire/Progeny Relationship — Formative / Bounded:** the sire is not a permanent parent or master. The sire's primary responsibility is to teach House philosophy, teach the House Feeding Doctrine, guide the progeny toward developing their own Measure, and help prepare them to endure immortality responsibly. Once the progeny has genuinely developed their own Measure and becomes philosophically self-sufficient, the sire's authority naturally ends; from that point they relate as fellow House members rather than teacher and student. **Lifelong moral responsibility:** although authority ends, responsibility does not. *"A sire remains morally responsible for every progeny they create for the rest of both of their lives."* If a progeny eventually succumbs to the Withering or full Corruption, other vampires may question what the sire failed to teach. This responsibility is **moral, not legal**; it creates lasting emotional and philosophical consequences throughout vampire society. **Connection to the Measure (V-3):** developing a Measure remains the defining milestone of vampire maturity — a vampire without a Measure is spiritually immature regardless of physical age; the Measure marks the transition from student to self-guided immortal. **Design philosophy:** the purpose of these systems is not to make vampires sympathetic — it is to make them **morally understandable**. Every vampire wrestles with immortality, responsibility, restraint, philosophy, and the consequences of creating another immortal. **Canonical principles (preserve in future lore):** (1) *"To create another immortal is the greatest responsibility a vampire can accept."* (2) *"A sire's authority ends when their progeny finds their own Measure. Their responsibility never does."* **Do not fully author the Schism or the lost civilization yet.** V-4 completes the four foundational philosophical pillars of vampire civilization (V-1 through V-4); future vampire quests, companions, NPCs, and the eventual Vampire Legacy Questline build upon this foundation. | Feb 2026 |
| 9 | V-5 | ✅ CANONICAL | **Repository Synchronization — APPROVED.** Current canonical sources (`docs/world/vampire_houses.md`, `docs/world/goblin_tribes.md`) are the source of truth. All outdated information exists only in legacy summary documents (`docs/lore/world/WORLD_FOUNDATION_SUMMARY.md`, `docs/roadmap.md`, one line in `docs/world/vampire_houses.md`). Treat as **repository synchronization work, not lore changes**. **During Phase 2 consolidation, replace:** *Vampire leadership* — Serath Vetharis → Cassiel Vetharis; Kira Drakmor → Morreth Drakmor; Mira Soleth → The Archivist (personal name unused for centuries). *Goblin leadership* — Grak → Grakkor; Elder Thorn (misassigned as tribe leader) → Elder Vess; Warchief Ember → Warchief Skarra. *Age framework* — obsolete "Age of Creation / Kingdoms / Wars / Shadows" → canonical D-01 "Age of Awakening / Harmony / Sundering / Restoration"; `vampire_houses.md` line 11 "Third Age — Age of Wars" → "early Age of Restoration" (historical event correctly placed per D-01; only label is stale). **Thorn is preserved as a canonical Mossroot NPC** — his role in `docs/world/goblin_tribes.md` line 98 as Mossroot War Leader (younger goblin who commands hunters and defers to Vess in political matters, per canonical Council-of-Elders structure) stands unchanged. The `WORLD_FOUNDATION_SUMMARY.md` error was a role-misassignment in a summary file; his actual canonical role never changed. **This preservation of Thorn exemplifies the Legacy Character philosophy** (see P-01): outdated *listings* are corrected without discarding *characters*. Reserved legacy figures (Serath, Kira, Mira Soleth, Grak, Ember) are captured in `/app/LEGACY_CHARACTER_RESERVE.md` with recommended future roles. **Total corrections: 8 edits across 3 files** (`WORLD_FOUNDATION_SUMMARY.md` — 6; `docs/roadmap.md` — 1; `docs/world/vampire_houses.md` — 1), plus 4 files flagged for Phase 2 Age-framework sweep. **All corrections deferred to Phase 2 consolidation** per user directive (Option B); no repository files modified during Canon Lock. Full audit in `/app/V5_V6_RECONCILIATION_REPORT.md`. | Feb 2026 |
| 10 | V-6 | ✅ CANONICAL | **Fang-Hold Layered Interpretation — APPROVED.** Fang-Hold is a **single canonical settlement with two connected districts**. **Upper Fang-Hold** — the ancient Stonefang fortress; seat of Warchief Grakkor; center of Stonefang tribal government; the oldest portion of the settlement. **Lower Fang-Hold** — the trade settlement that gradually developed beneath the fortress along the trade road Stonefang has taxed for generations; mixed-race, commercial, supported by travelers, merchants, caravans, diplomats, and craftsmen; where most outsiders experience Fang-Hold. **Both locations are legitimately called Fang-Hold; neither name is incorrect.** When precision is required, locals may distinguish between "Upper Fang-Hold," "Lower Fang-Hold," "The Trade Quarter," or "The Fortress" — depending on local custom. **Additional canon — the symbolic relationship:** the two districts symbolize the broader relationship between the Stonefang tribe and the outside world. Upper Fang-Hold represents *tradition, governance, tribal identity, history*. Lower Fang-Hold represents *commerce, diplomacy, cultural exchange, opportunity*. **The two communities depend upon one another; neither could exist in its current form without the other.** This reinforces one of the central themes of the Stonefang tribe. **New canonical Stonefang principle (preserve in future lore):** *"Strength is not isolation. Strength is knowing what is worth protecting and what is worth building."* **All existing statements about Fang-Hold in goblin canon (Stonefang fortified promontory, Grakkor's seat, trade-road toll leverage) AND vampire canon (mid-sized frontier trading post, town/merchant council, Iron Serration mercenary contract, Vetharis embedded agents) become simultaneously true.** No canon rewrites required; the layered reading strengthens both existing quest arcs and creates natural cross-faction quest surface for players with both Stonefang and vampire-House reputation. Minor implications (formal Stonefang/merchant-council relationship; Iron Serration acknowledgment of Stonefang authority in transit; Grakkor's implicit position on merchant-council deals) preserved as *discoverable* per the Preserving Wonder directive — worth defining later when the vampire and goblin arcs converge, not now. | Feb 2026 |
| — | P-01 | ✅ CANONICAL (POLICY) | **Legacy Character Reserve — established as ongoing worldbuilding policy.** New permanent document at `/app/LEGACY_CHARACTER_RESERVE.md` preserves retired/replaced/superseded characters for future repurposing rather than deletion. Guiding principles: *"Nothing meaningful is wasted"* and *"Whenever practical, legacy characters should be repurposed before being removed from canon."* The document is **not a graveyard** — it is a pool of future NPCs, historical figures, mentors, villains, scholars, merchants, quest givers, explorers, and legends. **Ongoing workflow:** whenever a major character is replaced, evaluate for repurposing first; move to the Reserve with recommended future roles if suitable; use the **Reserved** subsection if no immediate role exists; only permanently remove if the character genuinely cannot strengthen the world. **Initial population (all P1):** Serath Vetharis (Vetharis historical / potential Schism-era reformer), Kira Drakmor (Morreth's potential sire / Drakmor Old Guard predecessor), Mira Soleth (last Archivist-Queen; the Archivist's potential sire and predecessor; NOT to be confused with the canonical operative Mira Deln), Grak (removed Stonefang Chieftain — canonically accommodated by the Council chamber's inscribed-stones system), Ember (legendary Ashfire founding-era figure; potential origin story for Ember Hollow landmark and the Ash Oath tradition). **Thorn is NOT in the Reserve** — canonical Mossroot War Leader; his listing exists only to prevent confusion. **Rule of first consultation:** before inventing a new named character, check the Reserve. Elyndor grows from its own history rather than from an ever-expanding roll of new names. Cross-references: `PRESERVING_WONDER_DESIGN_DIRECTIVE.md`, `LIVING_WORLD_DESIGN_PILLAR.md`, `V5_V6_RECONCILIATION_REPORT.md`. | Feb 2026 |
| 4c | D-04c | ✅ CANONICAL | **Divine Chorus Theological Foundation — APPROVED (Option D custom reconciliation).** The Divine Chorus is now formally established as one of the foundational pillars of Elyndor at `/app/DIVINE_CHORUS.md` (500 lines). **The Chorus is eight Voices, each a fundamental truth about existence:** *Aurelion* (First Light — hope/renewal/mercy), *Kaelos* (Unbroken Forge — strength/discipline/duty), *Elyra* (Living Hearth — community/compassion), *Veridan* (Ever-Growing Root — life/nature/adaptation), *Solenne* (Keeper of Memory — knowledge/history/preservation), *Tyras* (Just Scale — justice/responsibility), *Lyssara* (Open Hand — creation/contribution/craftsmanship), *Noctis* (Quiet Veil — death/peace/acceptance). **Anchoring principle:** *"No single voice is the Chorus."* **No Voice is evil**; every virtue can become dangerous when isolated. **The Corruption is imbalance** — it amplifies the isolation of one Voice from the others, producing each Voice's *Corrupted Extreme* (fully consistent with V-2's Withering, the Goblin Corruption-Crime Protocol, and the world-universal Corruption principle). **Gods never physically appear**; the Chorus is encountered through dreams, visions, miracles, relics, holy places, and unexplained events — never as NPCs. **Living the virtue matters more than ritual.** **Reconciliation with prior canon (per user directive):** the seven previously-authored figures (Solaryn, Sylvara, Morvel, Eldris, Tharok, Neressa, Zephyros) are reclassified as **Heralds of the Chorus** — a new canonical subordinate theological category. Heralds are revered mortal, semi-mortal, or ancient figures whose lives articulated one Voice of the Chorus for a particular civilization; they are **not gods**. Confusing a Herald with a Voice is theological narrowing (sincere but incomplete). Every existing temple, relic, clergy tradition, sacred text, and religious institution is preserved intact; only the theological *framing* is clarified. **Canonical Herald-to-Voice mappings** (clear): Solaryn → Kaelos; Sylvara → Veridan; Morvel → Noctis; Eldris → Solenne. **Debated Herald mappings** (canonically unresolved theological debates preserved): Tharok (Kaelos or Veridan?); Neressa (Tyras or Elyra?); Zephyros (Lyssara or Aurelion?). **D-04 preserved:** the seven elemental aspects (Fire, Water, Earth, Air, Life, Death, Time) remain manifestations of Primordial Magic produced by the Sundering's fracturing of the First Song — they are how *magic manifests*, not the identities of the gods. Four Voices (Aurelion, Elyra, Tyras, Lyssara) have no canonical Herald — deliberate mystery. **No duplicate names for the same deity** — each Voice has one canonical identity; Heralds have their own. **The Forgotten Eighth remains a permanent theological mystery** — she is one of the eight Voices; which one is deliberately never resolved (some scholars claim Aurelion, some Elyra, some Tyras, some Lyssara, some claim her name is erased beyond any current tradition's memory). `elyndor/history/the_eighth.md`'s "she" characterization and Sundering narrative preserved; only her identity-by-Voice is refused. **Cultural interpretations preserved:** the four major traditions (Solari Covenant / Old Ways / Ancestors' Path / Veiled Order) remain canonical; each is now understood as a civilizational emphasis on particular Voice(s) via particular Herald(s), each with characteristic theological narrowing. **Civilizational emphases (per user directive):** Goblins → Lyssara/Veridan/Elyra; Humans → Tyras/Aurelion/Kaelos; Dwarves → Kaelos/Lyssara/Solenne; Elves → Veridan/Solenne/Noctis; Gnomes → Solenne/Lyssara; Vampires interpret through immortality (Vetharis Kaelos-order; Drakmor Kaelos-duty; Soleth Solenne-preservation — the tragedy per V-1 through V-4). **Companions:** each has a Chorus relationship established as characterization surface (not devotion requirement) — seeds provided in the document; full arcs authored in individual Hero Bibles. **Traditional prayers, temple architectures, oath formulas, funeral/marriage/pilgrimage/festival/sacred-text traditions** all canonized in the primary document. **Preserved documents (unchanged during Canon Lock):** `docs/lore/DIVINE_CHORUS.md`, `docs/lore/DIVINE_CHORUS_PHILOSOPHY.md`, `elyndor/history/the_eighth.md`, `elyndor/magic/MAGIC_BIBLE.md`, `docs/world/religions.md`. During Phase 2 consolidation, these docs will be reconciled with the new primary reference — no rewrites during Canon Lock. | Feb 2026 |
| — | A1–A8 | ✅ CANONICAL | **Goblin §33 Assumptions — Batch Ruling.** **A1** *(the gods = Divine Chorus)*, **A3** *(First Hearth Day ≠ First Hearth Tending)*, **A4** *(Corruption Response Protocol universal; emotional response cultural — now legible as Chorus-balance restoration under D-04c)*, **A5** *(Chroniclers + Story-Singers collaborate)*, **A8** *(Stonefang debt/memory/contribution loop — consistency observation)*: all CONFIRMED as-drafted. **A2** CONFIRMED WITH REVISION: First Contribution stays universal; Ashfire's Naming Night is now the *public ceremony recognizing* the completed Contribution and granting the adult name (rather than the Contribution being a prerequisite gate). **A6** CONFIRMED: Beastfolk and Halflings are canonical peoples of Elyndor; cultures to be authored later. **A7** UPDATED: "rare exception vampire" language removed from `GOBLIN_CULTURE.md` §26; exceptional vampires now arise ordinarily through V-3's Measure system; no special-case lore required. **GOBLIN_CULTURE.md §33 Assumptions block removed and replaced with Canonical Notes summary.** Goblin foundation now complete. | Feb 2026 |
| 5 | D-05 | ✅ CANONICAL | **Terminology for the Forgotten Eighth — Tiered Referents (Option C).** *"Ancient God"* RETIRED from future canon (theologically incompatible with the eight-Voice Divine Chorus per D-04c). **Developer documentation:** always use *"The Forgotten Eighth."* **Scholarly writing:** generally *"The Eighth."* **Religious writings and in-world folklore:** poetic titles preserved — *The Lost Voice*, *The Silent Voice*, *The Sundered One*, *The One Beyond the Final Verse*, *She Who Was Forgotten*. Different cultures naturally favor different titles. **Her identity by Voice remains permanently unresolved** per D-04c. | Feb 2026 |



*(4 approved + 1 expansion + 6 vampire rulings + 1 policy + 1 theological foundation of 30 base decisions + 6 vampire decisions + policy + theology tracks — 13 total canonical decisions. **Divine Chorus theological foundation (D-04c) COMPLETE.** Vampire foundation V-1 through V-6 COMPLETE. Next: §33 goblin assumptions A1–A8, then D-05.)*
