...
**Cross-scope rule:** collisions can pre-exist across documents. Before expanding any existing named character, grep the name across ALL of docs/ including docs/lore/ (the canon source of truth — the docs/lore/ character keeps the name; rename the other). Check titles as well as surnames.
