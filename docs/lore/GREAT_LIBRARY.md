...
> **Authority:** This document defines the canonical lore of the Great Library — its purpose, collections, access structure, politics, and campaign relevance. It is the primary authored source for this institution. Cross-reference with the Capital Province document for the Library's physical and political context.  
> **Cross-references:** [`docs/lore/IMPERIAL_CAPITAL.md`](IMPERIAL_CAPITAL.md) · [`docs/world/WORLD_BIBLE.md`](../world/WORLD_BIBLE.md) · [`elyndor/history/the_eighth.md`](../../elyndor/history/the_eighth.md) · [`elyndor/history/HISTORY_BIBLE.md`](../../elyndor/history/HISTORY_BIBLE.md) · [`docs/world/vampire_houses.md`](../world/vampire_houses.md)
...
By the Fourth Age, the Great Library contains:
- The largest single collection of Second Age historical documents on the continent
- The most comprehensive general magical theory archive outside the Mages Guild's specialist holdings
- Lineage records for most major noble and clan families, maintained in parallel with the Ancestors' Path's oral traditions
- Religious texts from all four traditions, including materials that each tradition's own clergy considers sensitive
- Maps — continent-scale, regional, and local — from all four ages, including First Age surveys whose accuracy cannot be verified because the territories they describe no longer exist in their recorded form
- Trade records, legal documents, and institutional histories that constitute the administrative memory of the Capital itself
- A sealed archive that is not included in the public catalogue

---

## The Building

The Great Library occupies its own block in the Academic Quarter, adjacent to the universities and within walking distance of the Mages Guild Headquarters. The building is Second Age in its bones — a structure of unusual permanence for its era, built with the assumption that what it contained would need to outlast the political arrangements of the moment.

Three subsequent expansions have been added, each identifiable by the architectural style of its age. The Third Age expansion is the largest; it was commissioned during a brief peace and completed as war resumed, which is why it is also the most fortified.

The interior is organized around the **Reading Halls** — large, well-lit spaces where catalogue-approved materials are brought to scholars who have requested them — and the **Stack Passages**, which run behind the Reading Halls and through which Library staff move materials from storage to presentation. Scholars do not enter the Stack Passages. This is a rule that is explained as preservation policy and enforced as something that has more layers to it than preservation policy.

The deepest storage levels are underground. The gnomish archivists who maintain them have been doing so for three generations. They know the layout better than any catalogue.
...
The Open Collection is available to any scholar who presents credentials recognized by the Library's admissions staff. Credentials include: university enrollment or faculty status, Mages Guild membership at any tier, recognized clergy status in any of the four major traditions, documented lineage research for one's own family, and — by longstanding arrangement — Adventurers Guild members presenting a contract that requires historical research.

The Open Collection is genuinely comprehensive. A scholar with access to it and the patience to use it can learn an enormous amount about the Second Age, the Third Age, the political history of the continent, the development of magical practice, and the organizational history of every major institution currently operating.

What the Open Collection does not contain is anything that would help a scholar connect the symptoms of the Corruption to a single cause, understand why some First Age ruins depict eight figures rather than seven, or explain why certain Second Age theological texts have passages that do not parse cleanly under a seven-member Chorus theology.

This is not accidental.

### The Restricted Collection

The Restricted Collection requires a letter of introduction from an established scholar and a statement of research purpose. Access is granted by the Library's senior staff, a process that involves more discretion than the formal policy suggests.

The Restricted Collection contains materials that are sensitive by subject rather than by content — documents that touch on topics the Library has learned, through experience, to handle carefully. Religious schism histories. Noble families whose current political positions make their documented Third Age activities inconvenient. Military actions whose official record does not match the primary sources. Early Corruption research.

Scholars who are given access to the Restricted Collection frequently find that the most useful documents in a given subject area are present in the catalogue, catalogued in the proper organizational scheme, and currently unavailable for reasons that vary by document and resist consolidation into a single explanation.

### The Sealed Archive

The Sealed Archive is not in the public catalogue.

It exists in the lowest underground level of the Library, in a section that the gnomish archivists maintain under separate protocols from the rest of the collection. It is not discussed by Library staff with researchers. Its existence is known to a small number of senior figures in the Capital's institutional network — the Library's Director, the relevant Mages Guild council members, the Veiled Order's Capital representative, and, through channels that are harder to trace, the senior figures of House Soleth.

The Sealed Archive contains materials that were placed there deliberately, at specific historical moments, with the explicit intention that they not surface in ordinary research. The earliest sealed materials date to the Second Age. The most recent were added during the Third Age's final decade, during the same period when the Corruption's early signs were beginning to be noticed and documented by scholars who were then, in several cases, not heard from again.

What the Sealed Archive contains is not fully known even to its current custodians. The materials were sealed by people who believed their successors would understand the context. That context has not been reliably transmitted.
...
The Order's Capital representative — who holds the title **Senior Archivist** within the Order and works under the Library's institutional umbrella as a "specialist consultant on historical documents" — has access to the Restricted Collection by default and to the Sealed Archive under conditions that are not publicly stated.

The Veiled Archivists, as they are known colloquially, have developed over generations into the Library's most reliable source of expertise on First Age materials. Their knowledge of ancient languages, archival organization practices, and the theological frameworks of pre-Forgetting religious texts is unmatched. The Library's staff finds them indispensable. The Library's senior administration finds them uncomfortable to refuse.

The most significant Veiled Archivist currently operating is **Carros**, whose own research into the discrepancies in First Age theological texts has reached conclusions that the Library's administration has formally requested he not publish through the Library's own distribution channels. His research files are maintained in a private study adjacent to the Restricted Collection. They constitute one of the most complete accounts of the Great Forgetting that any living scholar has assembled.

These files are the subject of a high-reputation quest available to players who have built significant standing with the Veiled Order. See [`docs/quests/religious_order_quests.md`](../quests/religious_order_quests.md).

---

## The Gnomish Archivists

The gnomish community in the Academic Quarter provides most of the Library's permanent archival staff.

Gnomes brought their tradition of meticulous record-keeping from the Iron Peaks, where they serve as archivists for the dwarven kingdoms, and applied it to the Library's scale of material with results that have made them functionally irreplaceable. The Library's indexing system, its preservation protocols, and its cataloguing conventions were all developed or substantially revised by gnomish archivists over the past two centuries.

The current head of gnomish archival staff is a figure known within the institution as **the Senior Index** — a gnome whose personal name is used only by colleagues, never in official correspondence, and who has been in the position long enough that several of the Library's senior human staff are not certain whether this is the same individual they met when they were junior researchers or a successor who inherited the title along with the office.

The gnomish archivists know the Library's contents better than anyone. They also know its gaps better than anyone. They do not discuss the gaps with researchers. This is not quite the same as being forbidden to discuss them — it is simply a professional orientation that treats gaps as organizational problems to be resolved internally, not information to be shared externally.

---

## The Library and the Great Forgetting

The most important thing about the Great Library, for campaign purposes, is **what it does not contain**.

A scholar who knows what to look for — who knows enough about pre-Forgetting First Age theology to recognize when a text is working around a reference rather than including it — will find the Library's collection of First Age materials deeply strange. Passages that break off. Citations that lead to documents not in the catalogue. Theological arguments that begin with seven-member premises and contain, buried in their formal structure, traces of a framework that required eight.

The Library did not create these gaps. It inherited them.

Some gaps were created before the Library existed, by whoever made the first decisions about what to preserve and what to allow to disappear. Some were created during the Second Age, when the Great Forgetting was still actively progressing and materials were still being removed from circulation. Some were created during the Third Age, by people who believed — correctly, in some cases — that the information was dangerous to those who possessed it.

The Library's current senior staff did not create the gaps either. Most of them are not aware that the gaps form a pattern. The ones who are aware have concluded, with varying degrees of discomfort, that the pattern is above their institutional authority to address.

**For players:** The Great Library is one of the continent's most significant sites for uncovering evidence of the Great Forgetting. A player who arrives knowing what to look for will find more than the Library intends to show them. A player who arrives without that knowledge will find a comprehensive and impressive archive with frustrating organizational gaps and a Restricted Collection that seems to contain everything except the thing they actually need.

---

## Access as a Campaign Tool

The Library's access structure is a reflection of the Capital's institutional power dynamics, and it should be used as one.

| Access Level | How to Obtain | What It Opens |
|---|---|---|
| **Open Collection** | Standard academic or guild credentials | Comprehensive Second and Third Age material; useful but sanitized |
| **Restricted Collection** | Letter of introduction + research statement + staff discretion | Sensitive institutional history; early Corruption research; materials with inconvenient implications |
| **Sealed Archive** | Not available through normal channels | Survives only through Veiled Order relationship (high reputation), House Soleth negotiation (complicated), or direct access by other means |
| **Archivist knowledge** | Trust built with gnomish staff or Veiled Archivists | What the catalogue doesn't show; where the gaps are; what was removed and when |

A player who has built reputation with the Veiled Order has the most direct path to the Library's most significant materials. A player who has built reputation with House Soleth has a different path, with different costs. A player who has built neither may still find what they need — if they know which gaps to follow.
